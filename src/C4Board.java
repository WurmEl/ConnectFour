...
//------------------------------------------
  ...
  public C4Board(Player firstPlayer, Player secondPlayer) {
    ...
    int[] moveOrder = {3, 4, 2, 5, 1, 6, 0, 7}; // Works for both 7 and 8 columns

    for (int i = 0; i < NUMBER_OF_COLUMNS; i++) {
      firstPlayerMoves[i] = new C4Move(firstPlayer, moveOrder[i]);
      secondPlayerMoves[i] = new C4Move(secondPlayer, moveOrder[i]);
    }
